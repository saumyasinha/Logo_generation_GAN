...
# DATA_DIR = 'C:\\Users\Shivendra\Desktop\GAN\icon_dataset.npy'
# if len(DATA_DIR) == 0:
...
def generate_image(frame, true_dist):
    ...
    lib.save_images.save_images(samples.reshape((128, 3, 32, 32)), 'C:\\Users\Shivendra\Desktop\GAN\LLD_sharp_iwgan_output\samples_{}.jpg'.format(frame))
...
# train_gen = X_train[idx_train],y_train[idx_train]
# dev_gen=X_test[idx_test],y_test[idx_test]
...
with tf.Session() as session:
    ...
    for iteration in range(ITERS):
        ...
        if iteration % 1000 == 999:
            save_path = saver.save(session, "/tmp/model_vanilla_sharp.ckpt", global_step=iteration)
