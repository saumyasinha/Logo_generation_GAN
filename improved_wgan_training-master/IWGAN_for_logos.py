...
def generate_image(frame, true_dist):
    ...
    lib.save_images.save_images(samples.reshape((128, 3, 32, 32)), 'C:\\Users\Shivendra\Desktop\GAN\LLD_iwgan_output_repeat\samples_{}.jpg'.format(frame))
...
with tf.Session() as session:
    ...
    for iteration in range(ITERS):
        ...
        if iteration % 1000==999:
            save_path = saver.save(session, "/tmp/model_iwgan.ckpt", global_step=iteration)
