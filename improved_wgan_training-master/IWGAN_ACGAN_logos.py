...
with tf.Session() as session:
    ...
    def generate_image(frame, true_dist):
        ...
        lib.save_images.save_images(samples.reshape((100, 3, 32, 32)), 'C:\\Users\Shivendra\Desktop\GAN\iwgan_acgan_lld\samples_{}.png'.format(frame))
    ...
    for iteration in range(ITERS):
        ...
        if iteration % 1000 == 999:
            save_path = saver.save(session, "/tmp/model_ac_colo.ckpt", global_step=iteration)
