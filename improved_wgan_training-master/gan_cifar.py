...
DATA_DIR = 'C:\\Users\Shivendra\Desktop\GAN\cifar-10-batches-py'
if len(DATA_DIR) == 0:
...
def generate_image(frame, true_dist):
    ...
    lib.save_images.save_images(samples.reshape((128, 3, 32, 32)), 'C:\\Users\Shivendra\Desktop\GAN\CIFAR_iwgan_output\samples_{}.jpg'.format(frame))
